...
public class XSLTHyvaTietaa {
	...
	public static void main(String[] args)
		...
		try {
			...
			final File xmlFile = new File("hyvaTietaa2018.xml");
			final File result = new File("hyvaTietaa2018.html");
			...
			System.out
					.println("Muunnoksen tulos on tiedostossa hyvaTietaa2018.html");
